function userList() {
       ...
       $.ajax({
url: 'http://localhost:8080/users/', type: 'GET',
dataType: 'json',
...
function handleException(request, message, error) { let msg = "";
...
const User = {};
User.firstname = $("#firstname").val(); User.lastname = $("#lastname").val(); userAdd(User);
}
function userAdd(user) {
    $.ajax({
url: "http://localhost:8080/users", type: 'POST',
contentType:
